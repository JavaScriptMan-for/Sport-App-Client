...
export type Muscles = 'верх груди' | 'центр груди' | 'низ груди'
 | 'широчайшие мышцы спины' | 'круглые мышцы спины' | 'трапеция'
...
export type Place = 'улица и зал' | 'зал'
...
export class Exercise {
    ...
    return {
      ...
      name: this.name,
      place: this.place,
      groupMuscles: this.groupMuscles,
...
const thrust_down_block = new Exercise(
    ...
    "thrust_down",
    "зал",
    ["широчайшие мышцы спины", "трапеция"],
    6,
